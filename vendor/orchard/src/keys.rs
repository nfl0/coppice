...
impl SpendAuthorizingKey {
    /// Returns the canonical scalar witness for non-consensus application circuits.
    /// This does not alter Orchard transaction authorization semantics.
    pub fn to_scalar(&self) -> pallas::Scalar {
        pallas::Scalar::from_repr(<[u8; 32]>::from(&self.0)).unwrap()
    }
